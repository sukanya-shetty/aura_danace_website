...
<div class="container">
    <div class="image-container">
        <img src="fusn2.jpg" alt="Event Image">
    </div>
    <div class="form-container">
        <h1>Book Your Event</h1>
        <form id="eventBookingForm" action="payment_policy.php" method="post">
...
<div class="popup" id="paymentPopup">
    ...
    <form id="paymentDetailsForm" action="payment_policy.php" method="post">
