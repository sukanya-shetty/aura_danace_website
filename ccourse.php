...
<body>
    <div class="container">
        ...
        <form action="cagecheck.php" method="post">
            <div class="main">
                <div class="user">
                    <label>Name</label>
                ...
                <div class="user">
                    ...
                    <input type="text" name="mno" id="mno" maxlength="10" minlength="10" placeholder="Enter your Mobile Number" required>
                </div>
                ...
                <?php
                    $sql="SELECT * FROM classical WHERE form='Bharathanatyam'";
