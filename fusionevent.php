        ...
        <div class="values">
            ...
            <thead>
              <tr>
                ...
                $sql="SELECT s.name, s.email, s.phone, e.event_name, b.booking_date, s.address, b.status, b.amount FROM bookings b JOIN students s ON b.student_id = s.student_id JOIN events e ON b.event_id = e.event_id";
                ...
                if($result->num_rows>0){
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        $event_name = isset($row['event_name']) ? $row['event_name'] : 'N/A';
                        $booking_date = isset($row['booking_date']) ? $row['booking_date'] : 'N/A';
                    ...
                    echo "<tbody><tr><td colspan='8'>No bookings found</td></tr></tbody>";
                }
            echo "</table>";
            ?>
            <br><br>
            <button style="background: #7B74EC;margin-top:40px;margin-left:500px;width:100px;"><a href="eventss.php" style="text-decoration:none;color:white;">Back</a></button>
        </div>
    </section>
</body>
</html>